...
@auth
    @if(auth()->user()->tenant_id)
        ...
        <div class="bg-white border-bottom py-2 shadow-sm d-none d-md-block">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <span class="text-muted small">Organization: <span class="fw-bold text-dark">{{ auth()->user()->tenant->company_name }}</span></span>
                    <span class="text-muted small">Subscription: <span class="badge bg-syneria-green text-white">Free Trial</span></span>
                </div>
            </div>
        </div>
    @endif
